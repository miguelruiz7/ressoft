<div class="offcanvas-header m-3">
    <h5 class="offcanvas-title" id="offcanvasExampleLabel"> Agregar un nuevo usuario</h5>
...
<form id="usuarios">
    ...
    <div class="form-floating  mb-3">
        <input type="text" id="usr_nom"  name="usr_nom" class="form-control border-bottom border-0 border-bottom-2  bg-transparent rounded-0 " id="floatingInput">
        <label>Nombre de pila</label>
     <div id="e_usr_nom" class="form-text text-danger m-2"> </div>
    </div>

    <div class="form-floating  mb-3">
        <input type="email" id="usr_cor"  name="usr_cor" class="form-control border-bottom border-0 border-bottom-2  bg-transparent rounded-0 " id="floatingInput">
        <label>Correo electrónico</label>
     <div id="e_usr_cor" class="form-text text-danger m-2"> </div>
    </div>
