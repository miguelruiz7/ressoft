<div class="text-center m-4">
    <h5 class="offcanvas-title " id="offcanvasExampleLabel">¿Estás seguro que deseas eliminar el usuario?
    </h5>
</div>
<div class="text-center">
    <form id="usuariosElim">
        <input type="hidden" name="usr_uuid" value="{{$id}}">
